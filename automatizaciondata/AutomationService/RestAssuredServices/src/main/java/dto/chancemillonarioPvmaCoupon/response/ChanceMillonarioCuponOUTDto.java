package dto.chancemillonarioPvmaCoupon.response;

import java.util.ArrayList;

public class ChanceMillonarioCuponOUTDto {
    ...
    public int idTransaccionSolicitud;
    ...
    public String identidadVendedor;
    ...
    public int getIdTransaccionSolicitud() {
        return idTransaccionSolicitud;
    }

    public void setIdTransaccionSolicitud(int idTransaccionSolicitud) {
    ...
    public String getIdentidadVendedor() {
        return identidadVendedor;
    }

    public void setIdentidadVendedor(String identidadVendedor) {
        this.identidadVendedor = identidadVendedor;
    }
