package com.co.datacenter.stepsdefinitions.data_second_admin;
...
public class SecondDataAdminDefinition {
    ...
    public void sebastianOnTheSettingsPage() throws InterruptedException {
        Sebas.wasAbleTo(
    ...
    public void heEntersTheDocumentNumber() {
        Sebas.wasAbleTo(
                EnterDocumentTask.on()
        );
    }
