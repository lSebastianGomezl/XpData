package com.co.datacenter.userinterfaces.chance_tradicional.validation_of_add_max_game_chance;

import net.serenitybdd.screenplay.targets.Target;
import org.openqa.selenium.By;

public class AddMaxChanceInterface {
    ...
    public static Target ALERT_MAX_COMPLETE= Target.the("Maximo de juegos apostado").
