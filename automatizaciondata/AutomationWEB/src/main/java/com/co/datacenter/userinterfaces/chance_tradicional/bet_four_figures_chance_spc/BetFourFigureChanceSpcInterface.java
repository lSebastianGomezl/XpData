package com.co.datacenter.userinterfaces.chance_tradicional.bet_four_figures_chance_spc;

import net.serenitybdd.screenplay.targets.Target;
import org.openqa.selenium.By;

public class BetFourFigureChanceSpcInterface {
    ...
    public static Target SUCCESSFUL_PAY = Target.the("Titulo de pago exitoso").
    ...
    public static Target BTN_ACCEP = Target.the("aceptar alerta").
