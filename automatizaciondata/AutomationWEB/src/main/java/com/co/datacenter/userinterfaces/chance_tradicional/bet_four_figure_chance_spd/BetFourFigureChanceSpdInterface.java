package com.co.datacenter.userinterfaces.chance_tradicional.bet_four_figure_chance_spd;

import net.serenitybdd.screenplay.targets.Target;
import org.openqa.selenium.By;

public class BetFourFigureChanceSpdInterface {
    ...
    public static Target SEE_CHECK_BOX = Target.the("check_box visibles").
            located(By.className("/div[@class=\"Container33 lotteryCheckList\"]"));
