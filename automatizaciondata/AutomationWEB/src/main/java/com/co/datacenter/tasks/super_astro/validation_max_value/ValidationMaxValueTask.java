package com.co.datacenter.tasks.super_astro.validation_max_value;
...
public class ValidationMaxValueTask implements Task {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Enter.theValue("50000").into(SendSuperAstroOneInterface.INPUT_VALUE)
    ...
    public static ValidationMaxValueTask on(){
        return instrumented(ValidationMaxValueTask.class);
    }
}
