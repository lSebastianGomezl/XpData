package com.co.datacenter.userinterfaces.login.validation_of_empty_terms;

import net.serenitybdd.screenplay.targets.Target;

public class EmptyTermsInterface {
    ...
    public static Target CHECK_BOX_1 = Target.the("terminos").
            locatedBy("//*[@id=\"formMain:field_terminos\"]/div[2]/span");
    ...
    public static Target TITLE_ALERT = Target.the("alerta de no valido").
            locatedBy("//*[@id=\"formMain:j_idt47\"]/span[2]");
