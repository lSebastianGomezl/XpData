package com.co.datacenter.userinterfaces.chance_tradicional.bet_three_figures_chance_pta;

import net.serenitybdd.screenplay.targets.Target;
import org.openqa.selenium.By;

public class BetThreeFigureChancePtaInterface {
    ...
    public static Target CLICK_UPDATE= Target.the("clicl para habilitar los input").
            locatedBy("//*[@id=\"idDivModalidadPata\"]/div[2]/p");
     ...
     */
    public static Target INPUT_PATA= Target.the("input de valor pata").
            locatedBy("//*[@id=\"formChance:j_idt86\"]");
    public static Target INPUT_UNA= Target.the("input de valor una").
            locatedBy("//*[@id=\"formChance:j_idt89\"]");
    ...
    public static Target BTN_NEXT = Target.the("boton de siguiente").
            //located(By.xpath("//button[@id=\"mainForm:j_idt106\"]"));
            located(By.id("mainForm:j_idt107"));
    public static Target BTN_ACCEP = Target.the("boton de siguiente").
            //locatedBy("//button[@id=\"mainForm:j_idt424\"]");
            located(By.id("mainForm:j_idt426"));
