package com.co.datacenter.userinterfaces.login.validation_of_empty_password;

import net.serenitybdd.screenplay.targets.Target;

public class EmptyPasswordInterface {
    ...
    public static Target TITLE_ALERT = Target.the("alerta de no valido").
            locatedBy("//*[@id=\"formMain:j_idt38\"]/div/ul/li/span");
