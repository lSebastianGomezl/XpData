package com.co.datacenter.userinterfaces.super_chance.validation_min_value_super_chance;

import net.serenitybdd.screenplay.targets.Target;
import org.openqa.selenium.By;

public class MinValueSuperChanceInterface {
    ...
    public static Target BTN_RANDOM_FOUR = Target.the("boton random de cuatro cifras")
            .locatedBy("//*[@id=\"formChance:j_idt69:0:j_idt79\"]/span");
    ...
    public static Target SELECTED_VALUE = Target.the("valor seleccionado")
            .locatedBy("//*[@id=\"formChance:j_idt69:0:lstValorDistribuir_2\"]");
    ...
    public static Target TITLE_WELCOME = Target.the("Titulo de confirmacion de compra")
            .locatedBy("//*[@id=\"dialogoModalAdvertenciaValoresMaxMin\"]/div[2]/span[2]");

    public static Target BTN_ACCEPT_ALERT = Target.the("boton de aceptar alerta")
            .locatedBy("//button[@id=\"j_idt360\"]");
